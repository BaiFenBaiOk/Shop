...
<meta charset="utf-8">
		...
		<script src="${pageContext.request.contextPath }/assets/jquery/jquery-1.10.2.min.js"></script>
...
<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/uikit.min.css" />
	        <script src="${pageContext.request.contextPath }/assets/js/uikit.min.js"></script>
	        <script src="${pageContext.request.contextPath }/assets/js/uikit-icons.min.js"></script>
