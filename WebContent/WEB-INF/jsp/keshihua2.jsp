...
<body>
	<div class="row">
	  <div class="col-md-12" id="main" style="width: 1400px;height:400px;"></div>
	</div>
	<div class="row">
	  <div class="col-md-12" id="main2" style="width: 1400px;height:400px;"></div>
	</div>
	<div class="row">
        ...
        series : [
            {
                ...
                data:[
                    <c:forEach items="${t}" var="t2">
                    {value:"${t2.count}", name:"${t2.address}"},
                    </c:forEach>
                ],
                itemStyle: {
                    emphasis: {
