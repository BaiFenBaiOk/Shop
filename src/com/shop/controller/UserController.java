...
public class UserController {
	...
	public ModelAndView findAllByOrder(@RequestParam(name = "page", required = true, defaultValue = "1") int page,
	...
	public ModelAndView findAllGoodType(@RequestParam(name = "page", required = true, defaultValue = "1") int page,
			@RequestParam(name = "size", required = true, defaultValue = "4") int size) throws Exception {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView findAllGood(@RequestParam(name = "page", required = true, defaultValue = "1") int page,
			@RequestParam(name = "size", required = true, defaultValue = "4") int size) throws Exception {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView addGoodTypeNew(GoodType goodType) throws MyException {
